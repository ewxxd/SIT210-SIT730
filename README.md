...
I defined my pins and created a constant 30-second timer. I then initialized all my pins in the setup() method. I created several helper functions, buttonPressed() returns a boolean indicating if the button is pressed, turnOnAllLights() turns on both lights, turnOffOneLight(int ledName) turns off a specified light, and turnOnOneLight(int ledName) turns on a specified light.
